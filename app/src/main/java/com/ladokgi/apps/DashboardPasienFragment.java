            ...
            public void onComplete(@NonNull @NotNull Task<QuerySnapshot> task) {
                if(task.isSuccessful()){
                    for (DocumentSnapshot data : task.getResult()){
                        ...
                        boolean hasilP = data.get("perilaku.hasil", boolean.class);
                        boolean hasilNP = data.get("non-perilaku.hasil", boolean.class);
                        String status = data.get("status", String.class);
